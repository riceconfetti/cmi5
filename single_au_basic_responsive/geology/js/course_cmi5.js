 ...
 */
CourseCmi5Plugin.prototype.initialize = function (
  callbackOnInit,
 ...
 */
CourseCmi5Plugin.prototype.experienced = function (
  pageId,
  name,
  overallProgress
) {
 ...
 * @return {Promise}                The promise from the statement network call.
 */
CourseCmi5Plugin.prototype.captureInteractions = function (
  interactionList,
  opts
) {
  if (!this.cmi5) {
...
CourseCmi5Plugin.prototype._videoMakeStatement = function (videoObj, verb) {
  ...
  stmt.context.extensions["https://w3id.org/xapi/video/extensions/session-id"] =
    videoObj.session;
  stmt.context.extensions["https://w3id.org/xapi/video/extensions/length"] =
 ...
 * @private
 */
CourseCmi5Plugin.prototype._sendStatementViaLibFunction = function (
  statementFn
) {
  this.activeStatements += 1;
  this.callbackOnStatementSend(null, null, this.activeStatements);
